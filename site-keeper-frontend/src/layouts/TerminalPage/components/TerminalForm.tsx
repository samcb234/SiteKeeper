...
export const TerminalForm: React.FC<{reload: boolean, refresh: any}> = (props) =>{
    ...
    async function submitNewTerminal() {
        const url = config.API_URL+'/api/terminal/addNewTerminal'
        const terminal: Terminal = new Terminal(id,img,description,name)
    ...
    return(
        ...
        onClick={e => submitNewTerminal()}>Save</button>
        </div>
